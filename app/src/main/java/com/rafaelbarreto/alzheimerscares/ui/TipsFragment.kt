 ...
 * I use a [PdfRenderer] to render PDF pages as [Bitmap]s.
 */
class TipsFragment : Fragment(), View.OnClickListener {

    /**
     * The filename of the PDF.
     */
    private val FILENAME = "guia_pratico_cuidador.pdf"
    ...
    private fun updateUi() {
        ...
        activity?.title = getString(R.string.title_page_pdf_with_index, index + 1, pageCount)
    }
